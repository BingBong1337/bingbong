...
def peta():
    ...
    reaktionVuxen = ['Kan jag hjälpa dig?' ,'*Tittar på dig*', 'Bussen går om 2 minuter', 'Ursäkta jag har bråttom',
    'Ledsen jag läser tidningen']
    reaktionGamling = ['Känner jag dig?', 'God dag!', 'Kommer du ihåg 2010?, det var ett bra år',
    ...
    if len(buss) == 0:
        ...
        if s.ålder <= 12:
            ...
            print('Du petade på', s,'och', s.kön ,'reagerade på detta sätt -->', r.choice(reaktionGamling))
            print('------------------------------------------------------')
    return
