...
class Person():
    ...
    def __repr__(Person):
        return '{},{},{}' . format(Person.namn, Person.ålder, Person.kön)
    #def __str__(self):
...
def plockaUpp():
    if sum(passagerare) >= 25:
        ...
        namn = r.randint(1,25)
        if namn == 1:
          aPerson.setNamn('Love')
        elif namn == 2:
           aPerson.setNamn('Ashley')
        elif namn == 3:
          aPerson.setNamn('Charlie')
        elif namn == 4:
          aPerson.setNamn('Kim')
        elif namn == 5:
          aPerson.setNamn('Billie')
        elif namn == 6:
          aPerson.setNamn('Noa')
        elif namn == 7:
          aPerson.setNamn('Nico')
        elif namn == 8:
          aPerson.setNamn('Mika')
        elif namn == 9:
          aPerson.setNamn('Lee')
        elif namn == 10:
          aPerson.setNamn('Michele')
        elif namn == 11:
          aPerson.setNamn('Valentin')
        elif namn == 12:
          aPerson.setNamn('Minou')
        elif namn == 13:
          aPerson.setNamn('Lo')
        elif namn == 14:
          aPerson.setNamn('Cleo')
        elif namn == 15:
          aPerson.setNamn('Boobie')
        elif namn == 16:
          aPerson.setNamn('Robin')
        elif namn == 17:
          aPerson.setNamn('Jordan')
        elif namn == 18:
          aPerson.setNamn('Ziggy')
        elif namn == 19:
          aPerson.setNamn('Elliot')
        elif namn == 20:
          aPerson.setNamn('Eli')
        elif namn == 21:
          aPerson.setNamn('Dani')
        elif namn == 22:
          aPerson.setNamn('Taylor')
        elif namn == 23:
          aPerson.setNamn('Mango')
        elif namn == 24:
          aPerson.setNamn('Pixi')
        elif namn == 25:
          aPerson.setNamn('Filur')

        aPerson.setÅlder(r.randint(0,100))
        ...
        person.append(aPerson.namn)
        person.append(aPerson.kön)
        person.append(aPerson.ålder)
        #person.append(aPerson)
...
def gåAv():
    if sum(passagerare) == 0:
        ...
        passagerare.append(-1)
        print(f'Du släppte av {person[0:3]}, Du har nu {sum(passagerare)} passagerare')
        person.pop(0)
        person.pop(0)
        person.pop(0)
        gamal.pop(0)
...
def sammanlagdÅlder():
    if len(person) == 0:
        print('Finns inga att beräkna sammanlagda åldern på')
    else:
        print('Den sammanlagda åldern på bussen är',sum(gamal))
    return
...
def äldst():
    print(sorted(person, key= buss_sort, reverse=True))
...
def hittaPassagerare():
  try:
    ageTop = int(input("Vad är maxåldern för ålderspannet?"))
    ageBottom = int(input("Vad är minimumåldern för ålderspannet?"))
    if ageTop <= 18:
      print("Pedochaffis slår till igen...")
    for n in range(ageBottom, ageTop+1):
