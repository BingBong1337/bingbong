...
root = tk.Tk()
re =True
w = tk.Canvas(root,bg = 'yellow',width=1920,height=1080)
w.place(x=0,y=0)
Game = False
Game_Start = False
Rock = False
...
ShakeL = tk.PhotoImage(file = 'C:\Python 2\stensaxpåse\StenUppVänster.png')
ShakeR = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\StenUppHöger.png')
Shake45L = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\Sten45NerVänster.png')
Shake45R = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\Sten45NerHöger.png')
StenL = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\StenFrånVänster.png')
StenR = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\StenFrånHöger.png')
SaxL = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\SaxFrånVänster.png')
SaxR = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\SaxFrånHöger.png')
PåseL = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\PåseFrånVänster.png')
PåseR = tk.PhotoImage(file ='C:\Python 2\stensaxpåse\PåseFrånHöger.png')
table = tk.PhotoImage(file = 'C:\Python 2\stensaxpåse\Table.png')
Table = tk.Label(root,image=table)
